...
let Estudiante = function(name,age,genere,course,group){
    ...
    Persona.call(this,name,age,genere);
    this.course = course;
    this.group = group;

    //Método registrar
    this.registrar=function(){
        return document.write("El alumno "+this.name+ " de "+this.course+" "+this.group+" ha sido registrado."+"<br>");
    }
}
...
let Profesor = function(name,age,genere,module,level){
    ...
    this.asignar=function(){
        return document.write("El profesor "+this.name+" ha sido asignado en el módulo de "+this.module+"<br>");
    }
}
...
let persona3 = new Profesor("Cristina",38,"mujer","DWEC","Segundo");
